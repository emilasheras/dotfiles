...
# -----------------------------
# GUI apps beyond Chrome/Obsidian
# -----------------------------
...
install_snap_app() {
  ...
  sudo snap install "$snap_name" "${snap_args[@]}"
}
...
install_spotify() {
  install_snap_app "spotify" "Spotify"
}

install_telegram() {
  install_snap_app "telegram-desktop" "Telegram Desktop"
}

install_krita() {
  install_snap_app "krita" "Krita"
}
